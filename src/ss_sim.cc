...
//    TFile *f1 = TFile::Open("bgs_segs_3005.root");
    ...
    int ss_lower_limit = p.Get_simSS_Window()[0];
    int ss_upper_limit = p.Get_simSS_Window()[1];
    int bin_width = 1;
...
//    t->Draw(Form("ene%s%d>>simSeg_%s_%s%d(12000,1,12001)",side[i].c_str(),j,histname.c_str(),side[i].c_str(),j),"","");
    t->Draw(Form("ene%s%d>>simSeg_%s_%s%d(%d,%d,%d)",side[i].c_str(),j,histname.c_str(),side[i].c_str(),j,int((ss_upper_limit-ss_lower_limit)/bin_width),ss_lower_limit,ss_upper_limit),Form("eneAll>=%d&&eneAll<%d&&eneDSSD>0",tas_lower_limit, tas_upper_limit),"");
...
//    std::vector<std::string> filelist = {"2700","2800","2900","3000","3150","3300","3450","3600","3750","3900","4100","4300","4500","4700","4900","5100","5300","5500","5700","5900","6100","6300","6500","6700","6900","7100","7400","7700","8000","8300","8600","8900","9200","9500","9800","10100","10400","10800","11200","11600","12000","12400"};//,"Test"};
...
//    std::vector<std::string> filelist_samp = {"267","692_m1","692_m2"};
